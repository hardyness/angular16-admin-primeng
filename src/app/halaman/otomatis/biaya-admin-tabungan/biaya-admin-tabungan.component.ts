...
@Component({
  selector: 'app-biaya-admin-tabungan',
  templateUrl: './biaya-admin-tabungan.component.html',
  styleUrls: ['./biaya-admin-tabungan.component.scss']
})
export class BiayaAdminTabunganComponent {
  ...
  async listData(){
    ...
    return new Promise (resolve => {
      ...
      this.subHttp = this.api.postData(param, 'otomatisbiayatabungan/list', {headers}).subscribe((res: any) => {
        if (res.status == 1){
  ...
  async cekTambah(){
    ...
    return new Promise (() => {
      ...
      this.subHttp = this.api.postData(cekmenu, 'otomatisbiayatabungan/cek', {headers}).subscribe((res: any) => {
        if (res.status == 1){
          this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
          this.auth.logout();
        } else if (res.status == 99){
  ...
  async selectDebit(){
    ...
    return new Promise (resolve => {
      ...
      this.subHttp = this.api.postData(param, 'otomatisbiayatabungan/selectdebitbiayatabungan', {headers}).subscribe((res: any) => {
  ...
  async tambahDebit(){
    ...
    if(!this.formTambahDebit.valid){
      ...
      return new Promise (resolve => {
        ...
        this.subHttp = this.api.postData(paramTambah, 'otomatisbiayatabungan/tambahdebitbiayatabungan', {headers}).subscribe((res: any) => {
          if (res.status == 1){
            this.loadingButton = false;
            this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
            this.auth.logout();
  ...
  async selectKredit(){
    ...
    return new Promise (resolve => {
      ...
      this.subHttp = this.api.postData(param, 'otomatisbiayatabungan/selectkreditbiayatabungan', {headers}).subscribe((res: any) => {
  ...
  async tambahKredit(){
    ...
    if(!this.formTambahKredit.valid){
      ...
      return new Promise (resolve => {
        ...
        this.subHttp = this.api.postData(paramTambah, 'otomatisbiayatabungan/tambahkreditbiayatabungan', {headers}).subscribe((res: any) => {
          if (res.status == 1){
            this.loadingButton = false;
            this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
            this.auth.logout();
