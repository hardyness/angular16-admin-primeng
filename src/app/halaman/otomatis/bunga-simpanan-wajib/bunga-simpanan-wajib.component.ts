...
@Component({
  selector: 'app-bunga-simpanan-wajib',
  templateUrl: './bunga-simpanan-wajib.component.html',
  styleUrls: ['./bunga-simpanan-wajib.component.scss']
})
export class BungaSimpananWajibComponent {
  ...
  async listData(){
    ...
    return new Promise (resolve => {
      ...
      this.subHttp = this.api.postData(param, 'simpananwajib/list', {headers}).subscribe((res: any) => {
        if (res.status == 1){
  ...
  async cekTambah(){
    ...
    return new Promise (() => {
      ...
      this.subHttp = this.api.postData(cekmenu, 'simpananwajib/cek', {headers}).subscribe((res: any) => {
        if (res.status == 1){
          this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
          this.auth.logout();
        } else if (res.status == 99){
  ...
  async selectDebit(){
    ...
    return new Promise (resolve => {
      ...
      this.subHttp = this.api.postData(param, 'simpananwajib/selectdebitsimpananwajib', {headers}).subscribe((res: any) => {
  ...
  async selectKredit(){
    ...
    return new Promise (resolve => {
      ...
      this.subHttp = this.api.postData(param, 'simpananwajib/selectkreditsimpananwajib', {headers}).subscribe((res: any) => {
  ...
  async tambahDebit(){
    ...
    if(!this.formTambahDebit.valid){
      ...
      return new Promise (resolve => {
        ...
        this.subHttp = this.api.postData(paramTambah, 'simpananwajib/tambahdebitsimpananwajib', {headers}).subscribe((res: any) => {
          if (res.status == 1){
            this.loadingButton = false;
            this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
            this.auth.logout();
  ...
  async tambahKredit(){
    ...
    if(!this.formTambahKredit.valid){
      ...
      return new Promise (resolve => {
        ...
        this.subHttp = this.api.postData(paramTambah, 'simpananwajib/tambahkreditsimpananwajib', {headers}).subscribe((res: any) => {
          if (res.status == 1){
            this.loadingButton = false;
            this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
            this.auth.logout();
