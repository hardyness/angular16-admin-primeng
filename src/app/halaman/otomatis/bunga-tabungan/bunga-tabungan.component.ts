...
@Component({
  selector: 'app-bunga-tabungan',
  templateUrl: './bunga-tabungan.component.html',
  styleUrls: ['./bunga-tabungan.component.scss']
})
export class BungaTabunganComponent {
  ...
  async ngOnInit() {
    this.api.setHeader('Bunga Tabungan');
    this.getScreenSize();
  ...
  async listData(){
    ...
    return new Promise (resolve => {
      ...
      this.subHttp = this.api.postData(param, 'otomatisbungatabungan/list', {headers}).subscribe((res: any) => {
        if (res.status == 1){
  ...
  async cekTambah(){
    ...
    return new Promise (() => {
      ...
      this.subHttp = this.api.postData(cekmenu, 'otomatisbungatabungan/cek', {headers}).subscribe((res: any) => {
        if (res.status == 1){
          this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
          this.auth.logout();
        } else if (res.status == 99){
  ...
  async selectDebit(){
    ...
    return new Promise (resolve => {
      ...
      this.subHttp = this.api.postData(param, 'otomatisbungatabungan/selectdebitbungatabungan', {headers}).subscribe((res: any) => {
  ...
  async tambahDebit(){
    ...
    if(!this.formTambahDebit.valid){
      ...
      return new Promise (resolve => {
        ...
        this.subHttp = this.api.postData(paramTambah, 'otomatisbungatabungan/tambahkreditbungatabungan', {headers}).subscribe((res: any) => {
          if (res.status == 1){
            this.loadingButton = false;
            this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
            this.auth.logout();
  ...
  async selectKredit(){
    ...
    return new Promise (resolve => {
      ...
      this.subHttp = this.api.postData(param, 'otomatisbungatabungan/selectkreditbungatabungan', {headers}).subscribe((res: any) => {
  ...
  async tambahKredit(){
    ...
    if(!this.formTambahKredit.valid){
      ...
      return new Promise (resolve => {
        ...
        this.subHttp = this.api.postData(paramTambah, 'otomatisbungatabungan/tambahdebitbungatabungan', {headers}).subscribe((res: any) => {
          if (res.status == 1){
            this.loadingButton = false;
            this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
            this.auth.logout();
