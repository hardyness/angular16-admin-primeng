...
export class Struktur3Component {
  ...
  async listData(){
    ...
    return new Promise (resolve => {
      ...
      this.api.postData(param, 'struktur3/list', {headers}).subscribe((res: any) => {
  ...
  async cekTambah(){
    ...
    return new Promise (() => {
      ...
      this.api.postData(cekmenu, 'struktur3/cek', {headers}).subscribe((res: any) => {
        if (res.status == 1){
          this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
          this.auth.logout();
        } else if (res.status == 99){
  ...
  async selectStruktur1(){
    ...
    return new Promise (resolve => {
      ...
      this.api.postData(param, 'struktur3/selectstruktur3', {headers}).subscribe((res: any) => {
  ...
  async tambah(){
    ...
    if(!this.formStruktur2.valid){
      ...
      return new Promise (resolve => {
        ...
        this.api.postData(paramTambah, 'struktur3/tambah', {headers}).subscribe((res: any) => {
          if (res.status == 1){
            this.loadingButton = false;
            this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
            this.auth.logout();
  ...
  async dataList(id){
    ...
    return new Promise (() => {
      ...
      this.api.postData(dataPerbarui, 'struktur3/data', {headers}).subscribe((res: any) => {
        if (res.status == 1) {
  ...
  async perbarui(){
    ...
    if(!this.formStruktur2.valid){
      ...
      return new Promise (async resolve => {
        ...
        this.api.postData(paramPerbarui, 'struktur3/perbarui', {headers}).subscribe((res: any) => {
          if (res.status == 1){
            this.loadingButton = false;
            this.messageService.add({severity: 'error', summary: res.pesan, detail: 'Akses Anda ditolak!'});
            this.auth.logout();
  ...
  async hapusData(id){
    ...
    return new Promise (async resolve => {
      ...
      this.api.postData(paramHapus, 'struktur3/hapus', {headers}).subscribe((res: any) => {
