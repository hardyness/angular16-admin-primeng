...
export class SuplierComponent {
  ...
  tablecolom = [
    ...
    {namakolom: 'Nama Suplier', class: 'orderdata', order: 'nama_suplier'},
    {namakolom: 'Kode Suplier'},
    {namakolom: 'Lokasi Suplier', class: 'orderdata', order: 'lokasi_suplier'},
    {namakolom: 'Kontak'},
    {namakolom: 'PJ Suplier'},
  ...
  async listData(): Promise<void> {
    ...
    try {
      const data: any = this.api.postData(param, "listsuplier/" + this.page, { headers }, queryParams)
